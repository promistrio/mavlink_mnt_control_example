...
int write_message(int fd, const mavlink_message_t &message)
{
    char buf[300];
    ...
    int bytesWritten = write(fd, buf, len); // _write_port будет зависеть от реализации на джетсоне
